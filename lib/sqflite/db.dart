...
//تنبــــــــيـــه
//هذا الملف سنستطيع استخدامه في أي تطبيق وهو ملف اساسي وسنتعامل مع الداتابيس بثواني
...
// join() >> لربط اسم الداتابيس بالمسار تاعها
// DB_Name.db >> name of database
//DBpath >> name of path

//(''' >> وضع الثلاث نقاط هذه عشان ننزل سطر ومانكتب كل الكود بسطر واحد

//DBpath/DB_Name.db >> this is the path of database

//TEXT >> للنص
//INTEGER >> للعد
//REAL >> للعدد اللي بفاصلة
